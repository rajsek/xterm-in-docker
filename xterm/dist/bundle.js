...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__build_addons_webLinks_webLinks__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__build_addons_webLinks_webLinks___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__build_addons_webLinks_webLinks__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__build_addons_winptyCompat_winptyCompat__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__build_addons_winptyCompat_winptyCompat___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__build_addons_winptyCompat_winptyCompat__);
...
__WEBPACK_IMPORTED_MODULE_0__build_xterm__["applyAddon"](__WEBPACK_IMPORTED_MODULE_5__build_addons_webLinks_webLinks__);
__WEBPACK_IMPORTED_MODULE_0__build_xterm__["applyAddon"](__WEBPACK_IMPORTED_MODULE_6__build_addons_winptyCompat_winptyCompat__);
...
},{"./Strings":15,"./shared/utils/Browser":36,"./utils/Dom":39,"./utils/RenderDebouncer":41}],2:[function(require,module,exports){
"use strict";
...
},{"./Buffer":2,"./EventEmitter":8,"./SelectionModel":13,"./handlers/AltClickHandler":19,"./shared/utils/Browser":36,"./utils/MouseHelper":40}],13:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./AccessibilityManager":1,"./Buffer":2,"./BufferSet":3,"./CompositionHelper":6,"./EscapeSequences":7,"./EventEmitter":8,"./InputHandler":9,"./Linkifier":10,"./Parser":11,"./SelectionManager":12,"./SoundManager":14,"./Strings":15,"./Viewport":18,"./handlers/Clipboard":20,"./input/MouseZoneManager":21,"./renderer/ColorManager":23,"./renderer/Renderer":27,"./shared/utils/Browser":36,"./utils/CharMeasure":37,"./utils/MouseHelper":40,"./utils/ScreenDprMonitor":42}],17:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var Renderer = (function (_super) {
    ...
    function Renderer(_terminal, theme) {
        ...
        _this.colorManager = new ColorManager_1.ColorManager(document);
        if (theme) {
...
},{"../EventEmitter":8,"../utils/RenderDebouncer":41,"../utils/ScreenDprMonitor":42,"./ColorManager":23,"./CursorRenderLayer":24,"./LinkRenderLayer":26,"./SelectionRenderLayer":28,"./TextRenderLayer":29}],28:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
    ...
    TextRenderLayer.prototype.onGridChanged = function (terminal, startRow, endRow) {
        ...
        for (var y = startRow; y <= endRow; y++) {
            ...
            for (var x = 0; x < terminal.cols; x++) {
                ...
                if (bg < 256) {
                    this._ctx.save();
                    this._ctx.fillStyle = (bg === Types_2.INVERTED_DEFAULT_COLOR ? this._colors.foreground : this._colors.ansi[bg]);
...
function generateCharAtlas(context, canvasFactory, config) {
    ...
    var r = parseInt(config.colors.background.substr(1, 2), 16);
    var g = parseInt(config.colors.background.substr(3, 2), 16);
    var b = parseInt(config.colors.background.substr(5, 2), 16);
